        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TamanoTerreno = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Favorites", x => new { x.ClienteId, x.PropertyId });
                    table.ForeignKey(
                        name: "FK_Favorites_AspNetUsers_ClienteId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Messages_AspNetUsers_AgenteId",
                        column: x => x.AgenteId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Messages_AspNetUsers_ClienteId",
                        column: x => x.ClienteId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Offers_AspNetUsers_ClienteId",
                        column: x => x.ClienteId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Improvements_Nombre",
                table: "Improvements",
                column: "Nombre",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Messages_AgenteId",
                table: "Messages",
                column: "AgenteId");

            migrationBuilder.CreateIndex(
                name: "IX_Messages_ClienteId",
                table: "Messages",
                column: "ClienteId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PropertyTypes_Nombre",
                table: "PropertyTypes",
                column: "Nombre",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SaleTypes_Nombre",
                table: "SaleTypes",
                column: "Nombre",
                unique: true);
        }
